import{setBusy as n,confirmStep as a,disarmConfirm as s,timeAgo as i,escapeHTML as o,describeDevice as l}from"./notifications-inbox.js";import{initManagementAnalytics as r}from"./management-analytics.js";import{Picker as c,avatarOf as d,rosterLookup as u}from"../tools/chipPicker.js";import{renderANSI as p}from"../tools/ansi.js";import{b64urlToBytes as m,fetchSealed as b,importAesKey as f,openJSON as h,openText as g,siteRoot as y,vaultPrefix as v}from"../tools/vaultCrypto.js";import{enter as $,exit as w,pop as k}from"./editor/motion.js";let S=130,_=280,q="cubic-bezier(0.32, 0.72, 0, 1)",L="blur(3px)",T=["posts","notes","announcements"],C={announcement:"fa-bullhorn",post:"fa-file-lines",note:"fa-comment-dots"},H='<li class="bm-blank"><i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i></li>';function contentChanged(){try{window.dispatchEvent(new CustomEvent("redefine:content-resized"))}catch{}}function t(e,t){return(window.theme&&window.theme.management_i18n||{})[e]||t}function e(e,a){return o(t(e,a))}let M=null,x="",E=!1,I={compose:{mode:"all"},notifications:{type:"",items:[],cursor:0,more:!1,error:!1,loading:!1},followers:{items:[],cursor:0,more:!1,orphans:[],totals:null,error:!1,loading:!1,me:null,role:"admin"},posts:{items:[],audiences:{},editors:{},filter:"",loading:!1,queue:[],bar:null,busy:!1},blocklists:{posts:[],notes:[],announcements:[]},me:{admin:!1,panels:{},grades:{},id:0,login:""},collab:{people:[],roster:[],loading:!1,error:!1},log:{record:null,loading:!1,error:!1}},N=new Map;async function api(e,t={},a=!0){var i=await(async()=>{if(!window.blogAuth)return null;try{return await window.blogAuth.getSessionToken()}catch{return null}})();if(!i)return{ok:!1,status:401,data:null};i={method:t.method||"GET",headers:{Authorization:"Bearer "+i}};let s;void 0!==t.body&&(i.headers["Content-Type"]="application/json",i.body=JSON.stringify(t.body));try{s=await fetch(x+e,i)}catch{return{ok:!1,status:0,data:null}}if((401===s.status||403===s.status)&&a&&window.blogAuth)return await window.blogAuth.getSession(!0),api(e,t,!1);let n=null;try{n=await s.json()}catch{}return{ok:s.ok,status:s.status,data:n}}function morph(s,e,t){if(E)t();else{let i=e.getBoundingClientRect().height;e.style.transition="opacity 130ms ease, filter 130ms ease",e.style.opacity="0",e.style.filter=L,setTimeout(()=>{if(s.isConnected){let a=t()||s.firstElementChild;if(a){a.style.transition="none",a.style.opacity="0",a.style.filter=L;var e=a.getBoundingClientRect().height;s.style.overflow="hidden",s.style.height=i+"px",s.style.transition="height 280ms "+q,s.style.height=e+"px",a.style.transition="opacity 196ms ease, filter 196ms ease",a.style.opacity="1",a.style.filter="none";let t=e=>{"height"===e.propertyName&&(s.removeEventListener("transitionend",t),s.style.transition="",s.style.height="",s.style.overflow="",a.style.transition="",a.style.filter="",contentChanged())};s.addEventListener("transitionend",t)}}},S)}}async function lookupIdentity(e){var t=await u(e);return t.matched.length?t:{ok:(t=await api("/api/admin/lookup",{method:"POST",body:{ids:[e]}})).ok,matched:t.data&&t.data.matched||[]}}function makePicker(e,a,i){return new c(e,a,{lookup:lookupIdentity,t:t,...i})}function syncCompose(){var e,t,a,i,s,n=M.querySelector('[data-part="announce"]');n&&(e=n.querySelector(".bm-c-title"),t=n.querySelector(".bm-c-body"),a=n.querySelector(".bm-c-url"),i=n.querySelector(".bm-send"),s=N.get("audience"),e)&&i&&(n.querySelector(".bm-c-count").textContent=String(t.value.length),n=!("all"!==I.compose.mode)||s&&s.settled&&0<s.ids.length,i.disabled=!e.value.trim()||!a.value.trim()||!n)}function announcementId(e){e=String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,48);return`announce:${(new Date).toISOString().slice(0,10)}-${e||"untitled"}-`+Date.now().toString(36).slice(-4)}async function send(a){var i=M.querySelector('[data-part="announce"]'),s=i.querySelector(".bm-c-title").value.trim(),l=i.querySelector(".bm-c-body").value.trim(),r=i.querySelector(".bm-c-url").value.trim(),d=I.compose.mode,c=N.get("audience"),u=(n(a,!0),"all"===d?{kind:"all"}:{kind:d,users:c?c.ids:[]}),s=await api("/api/admin/notifications",{method:"POST",body:{id:announcementId(s),type:"announcement",topic:"announcements",title:s,body:l,url:r,tag:"announcements",audience:u}});n(a,!1),((i,s,{mode:a,audience:n})=>{if(i.hidden=!1,!s.ok){let a=s.data&&(s.data.error||s.data.message)||(s.status?"HTTP "+s.status:t("offline","The Worker did not answer."));return i.className="bm-receipt is-bad",i.innerHTML=`<div class="bm-receipt-head">
    ...
    <dl class="bm-receipt-grid">${l.map(([e,t])=>`<dt>${o(e)}</dt><dd>${o(null==t||""===t?"—":t)}</dd>`).join("")}</dl>`})(i.querySelector(".bm-receipt"),s,{mode:d,audience:u}),s.ok&&(i.querySelector(".bm-c-title").value="",i.querySelector(".bm-c-body").value="",i.querySelector(".bm-c-url").value="",c&&c.clear(),syncCompose(),setFilter(""))}function notifInnerHTML(a){let s="";try{let e=JSON.parse(a.audience_json||"{}");s="users"===e.kind?t("aud_only","Only these")+" "+(e.users||[]).length:"except"===e.kind?t("aud_except","Everyone except")+" "+(e.users||[]).length:"all"===e.kind?t("aud_all","Everyone"):t("aud_topic","By topic")}catch{}let n=[a.id,a.type,a.topic,a.source,a.recipients+" "+t("m_inboxes","inboxes"),a.devices+" "+t("m_devices","devices"),s,i(a.published_at)].filter(Boolean);return`
      <div class="bm-notif-inner">
        <span class="bm-notif-icon">
          <i class="fa-solid ${C[a.type]||"fa-bell"}" aria-hidden="true"></i>
        </span>
      ...
      </div>`}function notificationHTML(e){return`<li class="bm-notif" data-id="${o(e.id)}">${notifInnerHTML(e)}</li>`}function paintNotifications(){var t=M.querySelector('[data-part="notifications"]'),a=t.querySelector(".bm-notifs"),i=t.querySelector(".bm-foot"),s=I.notifications;t.querySelector(".bm-notif-count").textContent=s.items.length?String(s.items.length):"",t.classList.toggle("is-loading",s.loading),s.loading&&!s.items.length?a.innerHTML=H:s.error?a.innerHTML=`<li class="bm-blank">${e("unreachable","Couldn't reach the notification service.")}</li>`:s.items.length?a.innerHTML=s.items.map(notificationHTML).join(""):a.innerHTML=`<li class="bm-blank">${e("no_notifications","Nothing in the database for this filter.")}</li>`,i.innerHTML=s.more?`<button type="button" class="bm-quiet bm-more" data-more="notifications">
         <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
         <span class="np-btn-label">${e("load_more","Load more")}</span></button>`:"",contentChanged()}function setFilter(t){I.notifications.type=t,M.querySelectorAll(".bm-notif-filter button").forEach(e=>{e.classList.toggle("is-on",e.dataset.type===t)}),loadNotifications({reset:!0})}async function loadNotifications({reset:e=!1,trigger:t=null}={}){var a=I.notifications,e=(e&&(a.items=[],a.cursor=0,a.more=!1),t&&n(t,!0),a.loading=!0,paintNotifications(),`?type=${encodeURIComponent(a.type)}&cursor=`+a.cursor),t=await api("/api/admin/notifications"+e);a.loading=!1,a.error=!t.ok,t.ok&&t.data&&(a.items=a.items.concat(t.data.items||[]),a.more=null!=t.data.cursor,a.cursor=t.data.cursor||a.cursor),paintNotifications()}function startEdit(a){let i=I.notifications.items.find(e=>e.id===a.dataset.id);i&&!a.querySelector(".is-editing")&&morph(a,a.firstElementChild,()=>{a.innerHTML=(t=i,`
    ...
    </div>`);var t=a.querySelector(".bm-e-title");return t&&t.focus(),a.firstElementChild})}function cancelEdit(t){let e=I.notifications.items.find(e=>e.id===t.dataset.id);e&&morph(t,t.firstElementChild,()=>(t.innerHTML=notifInnerHTML(e),t.firstElementChild))}async function deleteNotification(e,t){let a=e.dataset.id;n(t,!0);var i=await api("/api/admin/notifications/"+encodeURIComponent(a),{method:"DELETE"});n(t,!1),i.ok&&(I.notifications.items=I.notifications.items.filter(e=>e.id!==a),t=e,i=paintNotifications,E?i():(e=t.getBoundingClientRect().height,t.style.overflow="hidden",t.style.height=e+"px",t.style.transition=`height 280ms ${q}, opacity 130ms ease`,t.style.opacity="0",t.style.height="0px",setTimeout(i,_)))}let A=["","encrypted","draft","unpublished","pinned"];function renderPostsShell(a){var i=[["",t("p_all","All")],["encrypted",t("p_encrypted","Encrypted")],["draft",t("p_drafts","Drafts")],["unpublished",t("p_unpublished","Unpublished")],["pinned",t("p_sticky","Sticky")]];a.innerHTML=`
    ...
    <div class="bm-post-bar">
      ...
      ${canCommit()?`<span class="bm-make">
               <a class="bm-write" href="${o(y()+"/blog-management/write/")}">
                 <i class="fa-solid fa-feather-pointed" aria-hidden="true"></i>
                 <span>${e("p_new","New post")}</span>
               </a>
               <a class="bm-write bm-write-album" href="${o(y()+"/blog-management/masonry/")}">
    ...
    <li class="bm-post${a.encrypted?" is-encrypted":""}${a.draft?" is-draft":""}${s?" is-queued":""}" data-key="${o(a.key)}">
      ...
      <div class="ed-progress">${P.map(([e,a,i])=>`<span class="ed-stage" data-key="${e}" data-state="wait">
         <i class="fa-solid ${a}" aria-hidden="true"></i>${o(t("p_s_"+e,i))}
       </span>`).join("")}</div>
      <div class="ed-notice" hidden></div>`,M.insertBefore(a,M.querySelector(".bm-console")),i.bar=a,holdCredentials(!0),a.querySelector(".bm-unpub-x").addEventListener("click",()=>closeBar()),a.querySelector(".bm-unpub-go").addEventListener("click",()=>(async()=>{var s=I.posts;if(!s.busy&&s.queue.length){var o=(()=>{let t=new Set(I.posts.queue);return I.posts.items.filter(e=>t.has(e.key))})();if(o.length){let a=s.bar,i=a.querySelector(".bm-unpub-go");s.busy=!0,M.classList.add("is-unpublishing"),n(i,!0),a.querySelector(".ed-dot").dataset.state="busy",barNotice(null,"");for(let e of o)rowEl(e.key)?.classList.add("is-working");try{let[e,a]=await Promise.all([loadRepo(),import("./editor/session.js")]),i=(await e.open(!0),await a.unpublishAll(o));if(!i)throw new Error(t("p_unpub_empty","There was nothing to commit."));markStage("committed","done"),barNotice("info",(t("p_unpub_done","Committed")+" "+(i.short||"")).trim()),!1===i.started&&barNotice("warn",t("p_unpub_unstarted","Committed and queued, but the build was not started — try the operation again to retry."));for(let e of o)e.published=!1,"album"!==e.kind&&(e.encrypted=!1),e.draft=e.draft||{id:"",slug:e.slug||"",href:e.href,source:e.source},"album"!==e.kind&&(e.vaultId="");s.queue=[],paintPosts();{var l=i.sha;clearInterval(O),markStage("building","live");let a=0;O=setInterval(async()=>{if(100<(a+=1))return clearInterval(O);var e=await(await loadRepo()).commitStatus(l);e&&e.count&&("pending"!==e.state?"success"===e.state?(clearInterval(O),markStage("building","done"),markStage("pushed","done"),markStage("deployed","live"),setTimeout(()=>{markStage("deployed","done"),barNotice("info",t("p_unpub_land","Done. Loading the site as readers see it…")),setTimeout(()=>window.location.assign(y()+"/blog-management/"),1200)},2e4)):"failure"!==e.state&&"error"!==e.state||(clearInterval(O),markStage("building","fail"),barNotice("error",t("p_unpub_failed","The build failed. The commit landed; nothing published has changed.")),I.posts.busy=!1,M.classList.remove("is-unpublishing")):markStage("building","live"))},6e3);return}}catch(e){markStage("committed","fail"),barNotice("error",e&&e.message||t("offline","The Worker did not answer.")),s.busy=!1,M.classList.remove("is-unpublishing"),n(i,!1),a.querySelector(".ed-dot").dataset.state="dirty";for(let e of o)rowEl(e.key)?.classList.remove("is-working")}}else closeBar()}})()),a.querySelector(".bm-unpub-backend").addEventListener("click",()=>(async()=>{var s=I.posts.bar;if(s&&!I.posts.busy){let e=s.querySelector(".bm-unpub-backend"),a=await loadRepo(),i=a.backends().find(e=>e.id!==a.activeId());if(i){e.disabled=!0;try{await a.use(i.id),await paintBackend()}catch(s){barNotice("error",t("unreachable","Couldn't reach the backend."))}finally{e.disabled=!1}}}})())}var s=i.queue.length;i.bar.querySelector(".bm-unpub-count").textContent=s+" "+t(1===s?"p_unpub_one":"p_unpub_many",1===s?"post to withdraw":"posts to withdraw"),a&&($(i.bar),paintBackend()),contentChanged()}:closeBar)())}function markStage(e,t){var a=I.posts.bar,a=a&&a.querySelector(`.ed-stage[data-key="${e}"]`);a&&a.dataset.state!==t&&(a.dataset.state=t,k(a))}function barNotice(e,t){var a,i=I.posts.bar;i&&(i=i.querySelector(".ed-notice"),t?(a="error"===e?"fa-circle-exclamation":"warn"===e?"fa-triangle-exclamation":"fa-circle-info",i.hidden=!1,i.dataset.kind=e,i.innerHTML=`<i class="fa-solid ${a}" aria-hidden="true"></i><span>${o(t)}</span>`,k(i)):i.hidden=!0)}async function closeBar(){var e=I.posts,t=(clearInterval(O),e.queue=[],e.busy=!1,M.classList.remove("is-unpublishing"),e.bar);e.bar=null,paintPosts(),t&&(holdCredentials(!1),await w(t),t.remove(),contentChanged())}async function paintBackend(){var s=I.posts.bar;if(s){var n,l,r=s.querySelector(".bm-unpub-backend");let e;try{await(e=await loadRepo()).open(!1)}catch(s){return void(r.hidden=!0)}let a=e.backends(),i=e.activeId();!i||a.length<2?r.hidden=!0:(n=a.find(e=>e.id===i),l=a.find(e=>e.id!==i),r.hidden=!1,r.dataset.backend=i,r.innerHTML=`<i class="${j[i]||j.gitea}" aria-hidden="true"></i><span>${o(n&&n.label||i)}</span>`,r.title=l?t("p_backend","Build on")+" "+(l.label||l.id):"")}}function renderFollowersShell(i){i.innerHTML=`
    <h2 class="bm-section-title">
    ...
    </li>`}function paintLog(){var a=M.querySelector('[data-part="buildlog"]');if(a){var s,i,n=a.querySelector(".bm-log-body"),a=a.querySelector(".bm-log-when"),l=I.log.record;if(!I.log.loading)return l?(i=l.status&&"success"!==l.status,a.textContent=String(l.at||"").replace("T"," ").slice(0,16),n.innerHTML=`
    ...
    <div class="bm-collab-list">${H}</div>`),l.buildlog&&(l.buildlog.innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-log-body">${H}</div>`),l.posts&&loadAudiences(),l.notifications&&loadNotifications({reset:!0}),l.followers&&loadFollowers({reset:!0}),l.buildlog&&(async()=>{I.log.loading=!0,paintLog();try{var e=await api("/api/editor/keys",{method:"POST",body:{}}),t=(e.data&&e.data.items||[]).find(e=>"log"===e.kind);if(!t)throw new Error("no key");var a=await b(`${v()}/${t.slug}/log.bin`);I.log.record=a?JSON.parse(await g(await f(m(t.key)),a)):null}catch(e){I.log.record=null}I.log.loading=!1,paintLog()})()}function canCommit(){var e=window.theme&&window.theme.backend||{};return!(!e.online_editor||!e.online_editor.enable)}async function initBlogManagement(e,t){var a=document.getElementById("blog-management");a&&(M=a,N.clear(),I.me={admin:!(!t||!t.admin),panels:{},grades:{},id:0,login:""},I.compose.mode="all",I.notifications.type="",I.notifications.loading=!1,I.followers.loading=!1,I.posts.items=e&&e.items||[],I.posts.audiences={},I.posts.editors={},I.collab.roster=(window.theme&&window.theme.backend||{}).collaborators||[],I.log.record=null,I.posts.filter="",I.posts.queue=[],I.posts.bar=null,I.posts.busy=!1,clearInterval(O),E=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.theme&&window.theme.backend||{},x=window.blogAuth?window.blogAuth.resolveApiBase():String(a.api_url||"").replace(/\/+$/,""),wire(),await boot(),!e)&&M.querySelector('[data-part="posts"]')&&(I.posts.items=(t=((t=await api("/api/editor/keys",{method:"POST",body:{}})).data&&t.data.items||[]).filter(e=>"post"===e.kind||"album"===e.kind),await(await Promise.all(t.map(async e=>{try{var t,a=await b(`${v()}/${e.slug}/r.bin`);return a?{...t=await h(await f(m(e.key)),a),vaultId:t.vaultId||e.id,slug:t.slug||e.slug,canWrite:!0===e.write}:null}catch(e){return null}}))).filter(Boolean)),paintPosts())}export{initBlogManagement};