import{setBusy as n,confirmStep as s,disarmConfirm as a,timeAgo as i,escapeHTML as o,describeDevice as l}from"./notifications-inbox.js";import{initManagementAnalytics as r}from"./management-analytics.js";import{Picker as c,avatarOf as d}from"../tools/chipPicker.js";import{siteRoot as u}from"../tools/vaultCrypto.js";import{enter as p,exit as m,pop as b}from"./editor/motion.js";let f=130,h=280,y="cubic-bezier(0.32, 0.72, 0, 1)",g="blur(3px)",v=["posts","notes","announcements"],$={announcement:"fa-bullhorn",post:"fa-file-lines",note:"fa-comment-dots"},k='<li class="bm-blank"><i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i></li>';function contentChanged(){try{window.dispatchEvent(new CustomEvent("redefine:content-resized"))}catch{}}function t(e,t){return(window.theme&&window.theme.management_i18n||{})[e]||t}function e(e,a){return o(t(e,a))}let w=null,S="",_=!1,q={compose:{mode:"all"},notifications:{type:"",items:[],cursor:0,more:!1,error:!1,loading:!1},followers:{items:[],cursor:0,more:!1,orphans:[],totals:null,error:!1,loading:!1,me:null,role:"admin"},posts:{items:[],audiences:{},filter:"",loading:!1,queue:[],bar:null,busy:!1},blocklists:{posts:[],notes:[],announcements:[]}},T=new Map;async function api(e,t={},a=!0){var i=await(async()=>{if(!window.blogAuth)return null;try{return await window.blogAuth.getSessionToken()}catch{return null}})();if(!i)return{ok:!1,status:401,data:null};i={method:t.method||"GET",headers:{Authorization:"Bearer "+i}};let s;void 0!==t.body&&(i.headers["Content-Type"]="application/json",i.body=JSON.stringify(t.body));try{s=await fetch(S+e,i)}catch{return{ok:!1,status:0,data:null}}if((401===s.status||403===s.status)&&a&&window.blogAuth)return await window.blogAuth.getSession(!0),api(e,t,!1);let n=null;try{n=await s.json()}catch{}return{ok:s.ok,status:s.status,data:n}}function morph(s,e,t){if(_)t();else{let i=e.getBoundingClientRect().height;e.style.transition="opacity 130ms ease, filter 130ms ease",e.style.opacity="0",e.style.filter=g,setTimeout(()=>{if(s.isConnected){let a=t()||s.firstElementChild;if(a){a.style.transition="none",a.style.opacity="0",a.style.filter=g;var e=a.getBoundingClientRect().height;s.style.overflow="hidden",s.style.height=i+"px",s.style.transition="height 280ms "+y,s.style.height=e+"px",a.style.transition="opacity 196ms ease, filter 196ms ease",a.style.opacity="1",a.style.filter="none";let t=e=>{"height"===e.propertyName&&(s.removeEventListener("transitionend",t),s.style.transition="",s.style.height="",s.style.overflow="",a.style.transition="",a.style.filter="",contentChanged())};s.addEventListener("transitionend",t)}}},f)}}async function lookupIdentity(e){e=await api("/api/admin/lookup",{method:"POST",body:{ids:[e]}});return{ok:e.ok,matched:e.data&&e.data.matched||[]}}function makePicker(e,a,i){return new c(e,a,{...i,lookup:lookupIdentity,t:t})}function syncCompose(){var e,t,a,i,s,n=w.querySelector('[data-part="announce"]');n&&(e=n.querySelector(".bm-c-title"),t=n.querySelector(".bm-c-body"),a=n.querySelector(".bm-c-url"),i=n.querySelector(".bm-send"),s=T.get("audience"),e)&&i&&(n.querySelector(".bm-c-count").textContent=String(t.value.length),n=!("all"!==q.compose.mode)||s&&s.settled&&0<s.ids.length,i.disabled=!e.value.trim()||!a.value.trim()||!n)}function announcementId(e){e=String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,48);return`announce:${(new Date).toISOString().slice(0,10)}-${e||"untitled"}-`+Date.now().toString(36).slice(-4)}async function send(a){var i=w.querySelector('[data-part="announce"]'),s=i.querySelector(".bm-c-title").value.trim(),l=i.querySelector(".bm-c-body").value.trim(),r=i.querySelector(".bm-c-url").value.trim(),d=q.compose.mode,c=T.get("audience"),u=(n(a,!0),"all"===d?{kind:"all"}:{kind:d,users:c?c.ids:[]}),s=await api("/api/admin/notifications",{method:"POST",body:{id:announcementId(s),type:"announcement",topic:"announcements",title:s,body:l,url:r,tag:"announcements",audience:u}});n(a,!1),((i,s,{mode:a,audience:n})=>{if(i.hidden=!1,!s.ok){let a=s.data&&(s.data.error||s.data.message)||(s.status?"HTTP "+s.status:t("offline","The Worker did not answer."));return i.className="bm-receipt is-bad",i.innerHTML=`<div class="bm-receipt-head">
    ...
    <dl class="bm-receipt-grid">${l.map(([e,t])=>`<dt>${o(e)}</dt><dd>${o(null==t||""===t?"—":t)}</dd>`).join("")}</dl>`})(i.querySelector(".bm-receipt"),s,{mode:d,audience:u}),s.ok&&(i.querySelector(".bm-c-title").value="",i.querySelector(".bm-c-body").value="",i.querySelector(".bm-c-url").value="",c&&c.clear(),syncCompose(),setFilter(""))}function notifInnerHTML(a){let s="";try{let e=JSON.parse(a.audience_json||"{}");s="users"===e.kind?t("aud_only","Only these")+" "+(e.users||[]).length:"except"===e.kind?t("aud_except","Everyone except")+" "+(e.users||[]).length:"all"===e.kind?t("aud_all","Everyone"):t("aud_topic","By topic")}catch{}let n=[a.id,a.type,a.topic,a.source,a.recipients+" "+t("m_inboxes","inboxes"),a.devices+" "+t("m_devices","devices"),s,i(a.published_at)].filter(Boolean);return`
      <div class="bm-notif-inner">
        <span class="bm-notif-icon">
          <i class="fa-solid ${$[a.type]||"fa-bell"}" aria-hidden="true"></i>
        </span>
      ...
      </div>`}function notificationHTML(e){return`<li class="bm-notif" data-id="${o(e.id)}">${notifInnerHTML(e)}</li>`}function paintNotifications(){var t=w.querySelector('[data-part="notifications"]'),a=t.querySelector(".bm-notifs"),i=t.querySelector(".bm-foot"),s=q.notifications;t.querySelector(".bm-notif-count").textContent=s.items.length?String(s.items.length):"",t.classList.toggle("is-loading",s.loading),s.loading&&!s.items.length?a.innerHTML=k:s.error?a.innerHTML=`<li class="bm-blank">${e("unreachable","Couldn't reach the notification service.")}</li>`:s.items.length?a.innerHTML=s.items.map(notificationHTML).join(""):a.innerHTML=`<li class="bm-blank">${e("no_notifications","Nothing in the database for this filter.")}</li>`,i.innerHTML=s.more?`<button type="button" class="bm-quiet bm-more" data-more="notifications">
         <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
         <span class="np-btn-label">${e("load_more","Load more")}</span></button>`:"",contentChanged()}function setFilter(t){q.notifications.type=t,w.querySelectorAll(".bm-notif-filter button").forEach(e=>{e.classList.toggle("is-on",e.dataset.type===t)}),loadNotifications({reset:!0})}async function loadNotifications({reset:e=!1,trigger:t=null}={}){var a=q.notifications,e=(e&&(a.items=[],a.cursor=0,a.more=!1),t&&n(t,!0),a.loading=!0,paintNotifications(),`?type=${encodeURIComponent(a.type)}&cursor=`+a.cursor),t=await api("/api/admin/notifications"+e);a.loading=!1,a.error=!t.ok,t.ok&&t.data&&(a.items=a.items.concat(t.data.items||[]),a.more=null!=t.data.cursor,a.cursor=t.data.cursor||a.cursor),paintNotifications()}function startEdit(a){let i=q.notifications.items.find(e=>e.id===a.dataset.id);i&&!a.querySelector(".is-editing")&&morph(a,a.firstElementChild,()=>{a.innerHTML=(t=i,`
    ...
    </div>`);var t=a.querySelector(".bm-e-title");return t&&t.focus(),a.firstElementChild})}function cancelEdit(t){let e=q.notifications.items.find(e=>e.id===t.dataset.id);e&&morph(t,t.firstElementChild,()=>(t.innerHTML=notifInnerHTML(e),t.firstElementChild))}async function deleteNotification(e,t){let a=e.dataset.id;n(t,!0);var i=await api("/api/admin/notifications/"+encodeURIComponent(a),{method:"DELETE"});n(t,!1),i.ok&&(q.notifications.items=q.notifications.items.filter(e=>e.id!==a),t=e,i=paintNotifications,_?i():(e=t.getBoundingClientRect().height,t.style.overflow="hidden",t.style.height=e+"px",t.style.transition=`height 280ms ${y}, opacity 130ms ease`,t.style.opacity="0",t.style.height="0px",setTimeout(i,h)))}let L=["","encrypted","draft","unpublished","pinned"];function renderPostsShell(a){var i=[["",t("p_all","All")],["encrypted",t("p_encrypted","Encrypted")],["draft",t("p_drafts","Drafts")],["unpublished",t("p_unpublished","Unpublished")],["pinned",t("p_sticky","Sticky")]];a.innerHTML=`
    ...
    <div class="bm-post-bar">
      <div class="bm-seg bm-post-filter" role="group">
        ${i.map(([e,t])=>`<button type="button" data-filter="${o(e)}"${e===q.posts.filter?' class="is-on"':""}>${o(t)}</button>`).join("")}
      </div>
      ${canCommit()?`<span class="bm-make">
               <a class="bm-write" href="${o(u()+"/blog-management/write/")}">
                 <i class="fa-solid fa-feather-pointed" aria-hidden="true"></i>
                 <span>${e("p_new","New post")}</span>
               </a>
               <a class="bm-write bm-write-album" href="${o(u()+"/blog-management/masonry/")}">
    ...
    <li class="bm-post${a.encrypted?" is-encrypted":""}${a.draft?" is-draft":""}${s?" is-queued":""}" data-key="${o(a.key)}">
    ...
    </li>`}function paintPosts(){var o,l=w.querySelector('[data-part="posts"]');if(l){let a=l.querySelector(".bm-post-list"),s=q.posts,n=s.items.filter(e=>{return e=e,!((t=s.filter)&&("encrypted"===t?!e.encrypted:"draft"===t?!e.draft:"unpublished"===t?e.published:"pinned"===t&&!e.sticky));var t});l.querySelector(".bm-post-count").textContent=n.length||"",n.length?a.innerHTML=n.map(postRowHTML).join(""):a.innerHTML=`<li class="bm-blank">${e("p_empty","Nothing matches this filter.")}</li>`;for(let i of n)if(canGrant(i)){let e="vault:"+i.vaultId,a=l.querySelector(`[data-picker="${CSS.escape(e)}"]`);a&&((o=makePicker(e,a,{placeholder:t("aud_placeholder","GitHub login or numeric id, then Enter"),onCommit:e=>saveAudience(i.vaultId,e)})).set(s.audiences[i.vaultId]||[]),T.set(e,o))}contentChanged()}}async function saveAudience(e,t){let a=w.querySelector(`[data-save="${CSS.escape("vault:"+e)}"]`);var i;t.settled?(a&&(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i>'),t=t.entries,i=await api(`/api/admin/vault/${encodeURIComponent(e)}/audience`,{method:"PUT",body:{audience:t}}),a&&(a.innerHTML=i.ok?'<i class="fa-solid fa-check" aria-hidden="true"></i>':'<i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>',i.ok)&&setTimeout(()=>a.innerHTML="",1800),i.ok&&(q.posts.audiences[e]=t,e=(i=w.querySelector(`[data-picker="${CSS.escape("vault:"+e)}"]`))&&i.closest(".bm-post").querySelector(".bm-bubble.is-readers"))&&(e.querySelector("strong").textContent=t.length,e.dataset.empty=t.length?"0":"1")):a&&(a.innerHTML="")}let C=[["committed","fa-code-commit","Committed"],["building","fa-hammer","Building"],["pushed","fa-upload","Artifact pushed"],["deployed","fa-globe","Deployed"]],x={gitea:"fa-solid fa-server",github:"fa-brands fa-github"},H=null,E=null,M=null;function loadRepo(){return H=H||import("./editor/repo.js")}async function holdCredentials(e){var t=await(E=E||import("./editor/credentials.js"));e?t.hold():t.release()}function rowEl(e){return w.querySelector(`.bm-post[data-key="${CSS.escape(e)}"]`)}function toggleUnpublish(a){var i,s=q.posts;s.busy||(a=a.dataset.key,(i=s.queue.indexOf(a))<0?s.queue.push(a):s.queue.splice(i,1),paintPosts(),(s.queue.length?()=>{let i=q.posts,a=!i.bar;if(a){let a=document.createElement("div");a.className="ed-docbar bm-unpub",a.innerHTML=`
      ...
      <div class="ed-progress">${C.map(([e,a,i])=>`<span class="ed-stage" data-key="${e}" data-state="wait">
         <i class="fa-solid ${a}" aria-hidden="true"></i>${o(t("p_s_"+e,i))}
       </span>`).join("")}</div>
      <div class="ed-notice" hidden></div>`,w.insertBefore(a,w.querySelector(".bm-console")),i.bar=a,holdCredentials(!0),a.querySelector(".bm-unpub-x").addEventListener("click",()=>closeBar()),a.querySelector(".bm-unpub-go").addEventListener("click",()=>(async()=>{var s=q.posts;if(!s.busy&&s.queue.length){var o=(()=>{let t=new Set(q.posts.queue);return q.posts.items.filter(e=>t.has(e.key))})();if(o.length){let a=s.bar,i=a.querySelector(".bm-unpub-go");s.busy=!0,w.classList.add("is-unpublishing"),n(i,!0),a.querySelector(".ed-dot").dataset.state="busy",barNotice(null,"");for(let e of o)rowEl(e.key)?.classList.add("is-working");try{let[e,a]=await Promise.all([loadRepo(),import("./editor/session.js")]),i=(await e.open(!0),await a.unpublishAll(o));if(!i)throw new Error(t("p_unpub_empty","There was nothing to commit."));markStage("committed","done"),barNotice("info",(t("p_unpub_done","Committed")+" "+(i.short||"")).trim());for(let e of o)e.published=!1,"album"!==e.kind&&(e.encrypted=!1),e.draft=e.draft||{id:"",slug:e.slug||"",href:e.href,source:e.source},"album"!==e.kind&&(e.vaultId="");s.queue=[],paintPosts();{var l=i.sha;clearInterval(M),markStage("building","live");let a=0;M=setInterval(async()=>{if(100<(a+=1))return clearInterval(M);var e=await(await loadRepo()).commitStatus(l);e&&e.count&&("pending"!==e.state?"success"===e.state?(clearInterval(M),markStage("building","done"),markStage("pushed","done"),markStage("deployed","live"),setTimeout(()=>{markStage("deployed","done"),barNotice("info",t("p_unpub_land","Done. Loading the site as readers see it…")),setTimeout(()=>window.location.assign(u()+"/blog-management/"),1200)},2e4)):"failure"!==e.state&&"error"!==e.state||(clearInterval(M),markStage("building","fail"),barNotice("error",t("p_unpub_failed","The build failed. The commit landed; nothing published has changed.")),q.posts.busy=!1,w.classList.remove("is-unpublishing")):markStage("building","live"))},6e3);return}}catch(e){markStage("committed","fail"),barNotice("error",e&&e.message||t("offline","The Worker did not answer.")),s.busy=!1,w.classList.remove("is-unpublishing"),n(i,!1),a.querySelector(".ed-dot").dataset.state="dirty";for(let e of o)rowEl(e.key)?.classList.remove("is-working")}}else closeBar()}})()),a.querySelector(".bm-unpub-backend").addEventListener("click",()=>(async()=>{var s=q.posts.bar;if(s&&!q.posts.busy){let e=s.querySelector(".bm-unpub-backend"),a=await loadRepo(),i=a.backends().find(e=>e.id!==a.activeId());if(i){e.disabled=!0;try{await a.use(i.id),await paintBackend()}catch(s){barNotice("error",t("unreachable","Couldn't reach the backend."))}finally{e.disabled=!1}}}})())}var s=i.queue.length;i.bar.querySelector(".bm-unpub-count").textContent=s+" "+t(1===s?"p_unpub_one":"p_unpub_many",1===s?"post to withdraw":"posts to withdraw"),a&&(p(i.bar),paintBackend()),contentChanged()}:closeBar)())}function markStage(e,t){var a=q.posts.bar,a=a&&a.querySelector(`.ed-stage[data-key="${e}"]`);a&&a.dataset.state!==t&&(a.dataset.state=t,b(a))}function barNotice(e,t){var a,i=q.posts.bar;i&&(i=i.querySelector(".ed-notice"),t?(a="error"===e?"fa-circle-exclamation":"warn"===e?"fa-triangle-exclamation":"fa-circle-info",i.hidden=!1,i.dataset.kind=e,i.innerHTML=`<i class="fa-solid ${a}" aria-hidden="true"></i><span>${o(t)}</span>`,b(i)):i.hidden=!0)}async function closeBar(){var e=q.posts,t=(clearInterval(M),e.queue=[],e.busy=!1,w.classList.remove("is-unpublishing"),e.bar);e.bar=null,paintPosts(),t&&(holdCredentials(!1),await m(t),t.remove(),contentChanged())}async function paintBackend(){var s=q.posts.bar;if(s){var n,l,r=s.querySelector(".bm-unpub-backend");let e;try{await(e=await loadRepo()).open(!1)}catch(s){return void(r.hidden=!0)}let a=e.backends(),i=e.activeId();!i||a.length<2?r.hidden=!0:(n=a.find(e=>e.id===i),l=a.find(e=>e.id!==i),r.hidden=!1,r.dataset.backend=i,r.innerHTML=`<i class="${x[i]||x.gitea}" aria-hidden="true"></i><span>${o(n&&n.label||i)}</span>`,r.title=l?t("p_backend","Build on")+" "+(l.label||l.id):"")}}function renderFollowersShell(i){i.innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-orphans"></div>`,v.forEach(a=>{var e=i.querySelector(`[data-picker="${a}"]`);T.set(a,makePicker(a,e,{placeholder:t("aud_placeholder","GitHub login or numeric id, then Enter"),onCommit:e=>(async(e,t)=>{let a=w.querySelector(`[data-save="${e}"]`);var i;t.settled?(a&&(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i>'),i=await api("/api/admin/blocklists",{method:"PUT",body:{topic:e,users:t.ids}}),a&&(a.innerHTML=i.ok?'<i class="fa-solid fa-check" aria-hidden="true"></i>':'<i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>',i.ok)&&setTimeout(()=>a.innerHTML="",1800),i.ok&&(i=i.data&&i.data.users||[],(q.blocklists[e]=i).length!==t.ids.length)&&t.set(i)):a&&(a.innerHTML="")})(a,e)}))})}function stateTag(t){return"banned"===t?`<span class="bm-tag is-banned">${e("banned","Banned")}</span>`:"muted"===t?`<span class="bm-tag is-muted">${e("muted","Muted")}</span>`:""}function lockOn(e){var t;return e&&e.is_admin?"admin":(t=q.followers,e=e&&(null!=e.id?e.id:e.github_id),"collab"===t.role&&null!=t.me&&String(e)===String(t.me)?"you":"")}function moderationButtons(t,a,i,s){return"admin"===s?`<span class="bm-tag is-admin">${e("admin","Admin")}</span>`:"you"===s?`<span class="bm-tag is-you">${e("you","You")}</span>`:(s="banned"===i,`
    ...
    <li class="bm-follower${a.state?" is-"+a.state:""}" data-follower="${o(a.id)}">
      ...
      ${a.devices.length?`<ul class="bm-devices">${a.devices.map(e=>deviceHTML(e,s)).join("")}</ul>`:`<p class="bm-blank bm-no-devices">${e("no_devices","No push device registered.")}</p>`}
    </li>`}function paintFollowers(){var a=w.querySelector('[data-part="followers"]'),i=a.querySelector(".bm-followers"),s=a.querySelector(".bm-foot"),n=q.followers;n.totals&&(a.querySelector(".bm-follower-count").textContent=`${n.totals.followers} · ${n.totals.devices} `+t("m_devices","devices")),a.classList.toggle("is-loading",n.loading),n.loading&&!n.items.length?i.innerHTML=k:n.error?i.innerHTML=`<li class="bm-blank">${e("unreachable","Couldn't reach the notification service.")}</li>`:n.items.length?i.innerHTML=n.items.map(followerHTML).join(""):i.innerHTML=`<li class="bm-blank">${e("no_followers","Nobody follows the blog yet.")}</li>`,s.innerHTML=n.more?`<button type="button" class="bm-quiet bm-more" data-more="followers">
         <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
       ...
       <ul class="bm-devices">${n.orphans.map(e=>deviceHTML(e,lockOn(e))).join("")}</ul>`:"",contentChanged()}async function loadFollowers({reset:e=!1,trigger:t=null}={}){var i=q.followers,e=(e&&(i.items=[],i.cursor=0,i.more=!1),t&&n(t,!0),i.loading=!0,paintFollowers(),await api("/api/admin/followers?cursor="+i.cursor));if(i.loading=!1,i.error=!e.ok,e.ok&&e.data){let a=e.data;null!=a.me&&(i.me=a.me),a.role&&(i.role=a.role),i.items=i.items.concat(a.items||[]),i.more=null!=a.cursor,i.cursor=a.cursor||i.cursor,a.orphans&&(i.orphans=a.orphans),a.totals&&(i.totals=a.totals),a.blocklists&&(q.blocklists=a.blocklists,v.forEach(e=>{var t=T.get(e);t&&t.set(a.blocklists[e]||[])}))}paintFollowers()}function wire(){w.addEventListener("click",e=>{var i,e=e.target,o=e.closest(".bm-seg [data-mode]");if(o)return i=o.dataset.mode,q.compose.mode=i,(o=w.querySelector('[data-part="announce"]')).querySelectorAll(".bm-seg button").forEach(e=>{e.classList.toggle("is-on",e.dataset.mode===i)}),o.querySelector('[data-picker="audience"]').hidden="all"===i,o.querySelector(".bm-audience-hint").textContent="all"===i?t("aud_all_hint","Every follower receives this."):"users"===i?t("aud_only_hint","Only the readers listed here receive this."):t("aud_except_hint","Every follower except the readers listed here."),void syncCompose();o=e.closest(".bm-notif-filter [data-type]");if(o)setFilter(o.dataset.type);else{var o=e.closest(".bm-post-filter [data-filter]");if(o)return o=o.dataset.filter,q.posts.filter=L.includes(o)?o:"",w.querySelectorAll(".bm-post-filter button").forEach(e=>{e.classList.toggle("is-on",e.dataset.filter===q.posts.filter)}),void paintPosts();o=e.closest(".bm-send");if(o)send(o);else{o=e.closest(".bm-more");if(o)("followers"===o.dataset.more?loadFollowers:loadNotifications)({trigger:o});else{o=e.closest(".bm-edit");if(o)startEdit(o.closest(".bm-notif"));else{o=e.closest(".bm-cancel");if(o)cancelEdit(o.closest(".bm-notif"));else{o=e.closest(".bm-save");if(o)(async(e,t)=>{let a=e.dataset.id,i=q.notifications.items.find(e=>e.id===a);var s,o,l,r;i&&(s=e.querySelector(".bm-e-title").value.trim(),o=e.querySelector(".bm-e-body").value.trim(),l=e.querySelector(".bm-e-url").value.trim(),s)&&(n(t,!0),r=await api("/api/admin/notifications/"+encodeURIComponent(a),{method:"PUT",body:{title:s,body:o,url:l}}),n(t,!1),r.ok?(i.title=s,i.body=o,l&&(i.url=l),cancelEdit(e)):(e.classList.add("is-bad"),setTimeout(()=>e.classList.remove("is-bad"),1200)))})(o.closest(".bm-notif"),o);else{o=e.closest(".bm-del");if(o){let e=o.closest(".bm-notif");void(s(o,"del:"+e.dataset.id,"")&&deleteNotification(e,o))}else{o=e.closest(".bm-mod");if(o){let e=`mod:${o.dataset.scope}:${o.dataset.target}:`+o.dataset.next;void(s(o,e,t("confirm","Press again"))&&(async a=>{let e=a.dataset.scope,i=a.dataset.target,s=a.dataset.next;n(a,!0);var t=await api("/api/admin/moderation",{method:"PUT",body:"device"===e?{device_id:Number(i),state:s}:{github_id:Number(i),state:s}});if(n(a,!1),t.ok){a=q.followers;if("follower"===e){let e=a.items.find(e=>String(e.id)===String(i));e&&(e.state=s)}else{for(let t of a.items){let e=t.devices.find(e=>String(e.id)===String(i));e&&(e.state=s)}let e=a.orphans.find(e=>String(e.id)===String(i));e&&(e.state=s)}paintFollowers()}})(o))}else{o=e.closest(".bm-post-unpublish");o?toggleUnpublish(o.closest(".bm-post")):a()}}}}}}}}})}function boot(){var a,i,s={posts:w.querySelector('[data-part="posts"]'),analytics:w.querySelector('[data-part="analytics"]'),announce:w.querySelector('[data-part="announce"]'),notifications:w.querySelector('[data-part="notifications"]'),followers:w.querySelector('[data-part="followers"]')};s.posts&&(renderPostsShell(s.posts),paintPosts()),s.analytics&&r(s.analytics,w,t),s.announce&&((a=s.announce).innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-receipt" hidden></div>`,i=a.querySelector('[data-picker="audience"]'),T.set("audience",makePicker("audience",i,{placeholder:t("aud_placeholder","GitHub login or numeric id, then Enter"),onCommit:()=>syncCompose()})),a.querySelectorAll(".bm-field").forEach(e=>{e.addEventListener("input",syncCompose)}),syncCompose()),s.notifications&&(i=s.notifications,a=[["",t("f_all","All")],["announcement",t("f_announcements","Announcements")],["post",t("f_posts","Posts")],["note",t("f_notes","Notes")]],i.innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-seg bm-notif-filter" role="group">
      ${a.map(([e,t])=>`<button type="button" data-type="${o(e)}"${e===q.notifications.type?' class="is-on"':""}>${o(t)}</button>`).join("")}
    </div>
    <ul class="bm-notifs"></ul>
    <div class="bm-foot"></div>`),s.followers&&renderFollowersShell(s.followers),s.posts&&(async()=>{q.posts.loading=!0;var e=await api("/api/admin/vault");q.posts.loading=!1,e.ok&&e.data&&(q.posts.audiences=e.data.audiences||{}),paintPosts()})(),s.notifications&&loadNotifications({reset:!0}),s.followers&&loadFollowers({reset:!0})}function canCommit(){var e=window.theme&&window.theme.backend||{};return!(!e.online_editor||!e.online_editor.enable)}function initBlogManagement(e){var t=document.getElementById("blog-management");t&&(w=t,T.clear(),q.compose.mode="all",q.notifications.type="",q.notifications.loading=!1,q.followers.loading=!1,q.posts.items=e&&e.items||[],q.posts.audiences={},q.posts.filter="",q.posts.queue=[],q.posts.bar=null,q.posts.busy=!1,clearInterval(M),_=window.matchMedia("(prefers-reduced-motion: reduce)").matches,t=window.theme&&window.theme.backend||{},S=window.blogAuth?window.blogAuth.resolveApiBase():String(t.api_url||"").replace(/\/+$/,""),wire(),boot())}export{initBlogManagement};