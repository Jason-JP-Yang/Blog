import{setBusy as n,confirmStep as a,disarmConfirm as s,timeAgo as i,escapeHTML as o,describeDevice as l}from"./notifications-inbox.js";import{initManagementAnalytics as r}from"./management-analytics.js";import{Picker as c,avatarOf as d,rosterLookup as u}from"../tools/chipPicker.js";import{parseLog as p}from"../tools/ansi.js";import{albumDraftId as m,b64urlToBytes as b,fetchSealed as f,importAesKey as h,openJSON as g,openText as y,siteRoot as v,vaultPrefix as $}from"../tools/vaultCrypto.js";import{enter as w,exit as k,pop as S}from"./editor/motion.js";import{createRail as _}from"./editor/rail.js";let L=130,q=280,T="cubic-bezier(0.32, 0.72, 0, 1)",C="blur(3px)",x=["posts","notes","announcements"],H={announcement:"fa-bullhorn",post:"fa-file-lines",note:"fa-comment-dots"},M='<li class="bm-blank"><i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i></li>';function contentChanged(){try{window.dispatchEvent(new CustomEvent("redefine:content-resized"))}catch{}}function t(e,t){return(window.theme&&window.theme.management_i18n||{})[e]||t}function e(e,a){return o(t(e,a))}let E=null,N="",A=!1,I={compose:{mode:"all"},notifications:{type:"",items:[],cursor:0,more:!1,error:!1,loading:!1},followers:{items:[],cursor:0,more:!1,orphans:[],totals:null,error:!1,loading:!1,me:null,role:"admin"},posts:{items:[],audiences:{},editors:{},filter:"",loading:!1,queue:[],bar:null,busy:!1},blocklists:{posts:[],notes:[],announcements:[]},me:{admin:!1,panels:{},grades:{},id:0,login:""},collab:{people:[],roster:[],loading:!1,error:!1},log:{record:null,loading:!1,error:!1,view:null}},j=new Map;async function api(e,t={},a=!0){var i=await(async()=>{if(!window.blogAuth)return null;try{return await window.blogAuth.getSessionToken()}catch{return null}})();if(!i)return{ok:!1,status:401,data:null};i={method:t.method||"GET",headers:{Authorization:"Bearer "+i}};let s;void 0!==t.body&&(i.headers["Content-Type"]="application/json",i.body=JSON.stringify(t.body));try{s=await fetch(N+e,i)}catch{return{ok:!1,status:0,data:null}}if((401===s.status||403===s.status)&&a&&window.blogAuth)return await window.blogAuth.getSession(!0),api(e,t,!1);let n=null;try{n=await s.json()}catch{}return{ok:s.ok,status:s.status,data:n}}function morph(s,e,t){if(A)t();else{let i=e.getBoundingClientRect().height;e.style.transition="opacity 130ms ease, filter 130ms ease",e.style.opacity="0",e.style.filter=C,setTimeout(()=>{if(s.isConnected){let a=t()||s.firstElementChild;if(a){a.style.transition="none",a.style.opacity="0",a.style.filter=C;var e=a.getBoundingClientRect().height;s.style.overflow="hidden",s.style.height=i+"px",s.style.transition="height 280ms "+T,s.style.height=e+"px",a.style.transition="opacity 196ms ease, filter 196ms ease",a.style.opacity="1",a.style.filter="none";let t=e=>{"height"===e.propertyName&&(s.removeEventListener("transitionend",t),s.style.transition="",s.style.height="",s.style.overflow="",a.style.transition="",a.style.filter="",contentChanged())};s.addEventListener("transitionend",t)}}},L)}}async function lookupIdentity(e){var t=await u(e);return t.matched.length?t:{ok:(t=await api("/api/admin/lookup",{method:"POST",body:{ids:[e]}})).ok,matched:t.data&&t.data.matched||[]}}function makePicker(e,a,i){return new c(e,a,{lookup:lookupIdentity,t:t,...i})}function syncCompose(){var e,t,a,i,s,n=E.querySelector('[data-part="announce"]');n&&(e=n.querySelector(".bm-c-title"),t=n.querySelector(".bm-c-body"),a=n.querySelector(".bm-c-url"),i=n.querySelector(".bm-send"),s=j.get("audience"),e)&&i&&(n.querySelector(".bm-c-count").textContent=String(t.value.length),n=!("all"!==I.compose.mode)||s&&s.settled&&0<s.ids.length,i.disabled=!e.value.trim()||!a.value.trim()||!n)}function announcementId(e){e=String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,48);return`announce:${(new Date).toISOString().slice(0,10)}-${e||"untitled"}-`+Date.now().toString(36).slice(-4)}async function send(a){var i=E.querySelector('[data-part="announce"]'),s=i.querySelector(".bm-c-title").value.trim(),l=i.querySelector(".bm-c-body").value.trim(),r=i.querySelector(".bm-c-url").value.trim(),d=I.compose.mode,c=j.get("audience"),u=(n(a,!0),"all"===d?{kind:"all"}:{kind:d,users:c?c.ids:[]}),s=await api("/api/admin/notifications",{method:"POST",body:{id:announcementId(s),type:"announcement",topic:"announcements",title:s,body:l,url:r,tag:"announcements",audience:u}});n(a,!1),((i,s,{mode:a,audience:n})=>{if(i.hidden=!1,!s.ok){let a=s.data&&(s.data.error||s.data.message)||(s.status?"HTTP "+s.status:t("offline","The Worker did not answer."));return i.className="bm-receipt is-bad",i.innerHTML=`<div class="bm-receipt-head">
    ...
    <dl class="bm-receipt-grid">${l.map(([e,t])=>`<dt>${o(e)}</dt><dd>${o(null==t||""===t?"—":t)}</dd>`).join("")}</dl>`})(i.querySelector(".bm-receipt"),s,{mode:d,audience:u}),s.ok&&(i.querySelector(".bm-c-title").value="",i.querySelector(".bm-c-body").value="",i.querySelector(".bm-c-url").value="",c&&c.clear(),syncCompose(),setFilter(""))}function notifInnerHTML(a){let s="";try{let e=JSON.parse(a.audience_json||"{}");s="users"===e.kind?t("aud_only","Only these")+" "+(e.users||[]).length:"except"===e.kind?t("aud_except","Everyone except")+" "+(e.users||[]).length:"all"===e.kind?t("aud_all","Everyone"):t("aud_topic","By topic")}catch{}let n=[a.id,a.type,a.topic,a.source,a.recipients+" "+t("m_inboxes","inboxes"),a.devices+" "+t("m_devices","devices"),s,i(a.published_at)].filter(Boolean);return`
      ...
      </div>`}function notificationHTML(e){return`<li class="bm-notif" data-id="${o(e.id)}">${notifInnerHTML(e)}</li>`}function paintNotifications(){var t=E.querySelector('[data-part="notifications"]'),a=t.querySelector(".bm-notifs"),i=t.querySelector(".bm-foot"),s=I.notifications;t.querySelector(".bm-notif-count").textContent=s.items.length?String(s.items.length):"",t.classList.toggle("is-loading",s.loading),s.loading&&!s.items.length?a.innerHTML=M:s.error?a.innerHTML=`<li class="bm-blank">${e("unreachable","Couldn't reach the notification service.")}</li>`:s.items.length?a.innerHTML=s.items.map(notificationHTML).join(""):a.innerHTML=`<li class="bm-blank">${e("no_notifications","Nothing in the database for this filter.")}</li>`,i.innerHTML=s.more?`<button type="button" class="bm-quiet bm-more" data-more="notifications">
         <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
         <span class="np-btn-label">${e("load_more","Load more")}</span></button>`:"",contentChanged()}function setFilter(t){I.notifications.type=t,E.querySelectorAll(".bm-notif-filter button").forEach(e=>{e.classList.toggle("is-on",e.dataset.type===t)}),loadNotifications({reset:!0})}async function loadNotifications({reset:e=!1,trigger:t=null}={}){var a=I.notifications,e=(e&&(a.items=[],a.cursor=0,a.more=!1),t&&n(t,!0),a.loading=!0,paintNotifications(),`?type=${encodeURIComponent(a.type)}&cursor=`+a.cursor),t=await api("/api/admin/notifications"+e);a.loading=!1,a.error=!t.ok,t.ok&&t.data&&(a.items=a.items.concat(t.data.items||[]),a.more=null!=t.data.cursor,a.cursor=t.data.cursor||a.cursor),paintNotifications()}function startEdit(a){let i=I.notifications.items.find(e=>e.id===a.dataset.id);i&&!a.querySelector(".is-editing")&&morph(a,a.firstElementChild,()=>{a.innerHTML=(t=i,`
    ...
    </div>`);var t=a.querySelector(".bm-e-title");return t&&t.focus(),a.firstElementChild})}function cancelEdit(t){let e=I.notifications.items.find(e=>e.id===t.dataset.id);e&&morph(t,t.firstElementChild,()=>(t.innerHTML=notifInnerHTML(e),t.firstElementChild))}async function deleteNotification(e,t){let a=e.dataset.id;n(t,!0);var i=await api("/api/admin/notifications/"+encodeURIComponent(a),{method:"DELETE"});n(t,!1),i.ok&&(I.notifications.items=I.notifications.items.filter(e=>e.id!==a),t=e,i=paintNotifications,A?i():(e=t.getBoundingClientRect().height,t.style.overflow="hidden",t.style.height=e+"px",t.style.transition=`height 280ms ${T}, opacity 130ms ease`,t.style.opacity="0",t.style.height="0px",setTimeout(i,q)))}let B=["","encrypted","draft","unpublished","pinned"];function renderPostsShell(a){var i=[["",t("p_all","All")],["encrypted",t("p_encrypted","Encrypted")],["draft",t("p_drafts","Drafts")],["unpublished",t("p_unpublished","Unpublished")],["pinned",t("p_sticky","Sticky")]];a.innerHTML=`
    ...
    <div class="bm-post-bar">
      <div class="bm-seg bm-post-filter" role="group">
        ${i.map(([e,t])=>`<button type="button" data-filter="${o(e)}"${e===I.posts.filter?' class="is-on"':""}>${o(t)}</button>`).join("")}
      </div>
    ...
    <li class="bm-post${a.encrypted?" is-encrypted":""}${a.draft?" is-draft":""}${s?" is-queued":""}" data-key="${o(a.key)}">
    ...
    </li>`}function paintPosts(){let o=E.querySelector('[data-part="posts"]');if(o){let a=o.querySelector(".bm-post-list"),n=I.posts,i=n.items.filter(e=>{return e=e,!((t=n.filter)&&("encrypted"===t?!e.encrypted:"draft"===t?!e.draft:"unpublished"===t?e.published:"pinned"===t&&!e.sticky));var t});o.querySelector(".bm-post-count").textContent=i.length||"",i.length?a.innerHTML=i.map(postRowHTML).join(""):a.innerHTML=`<li class="bm-blank">${e("p_empty","Nothing matches this filter.")}</li>`;for(let s of i){if(canGrant(s)){let a="vault:"+s.vaultId,i=o.querySelector(`[data-picker="${CSS.escape(a)}"]`);if(i){let e=makePicker(a,i,{placeholder:t("aud_placeholder","GitHub login or numeric id, then Enter"),onCommit:e=>saveAudience(s.vaultId,e)});e.set(n.audiences[s.vaultId]||[]),j.set(a,e)}}if(canAssign(s)){let a="edit:"+s.vaultId,i=o.querySelector(`[data-picker="${CSS.escape(a)}"]`);if(i){let e=makePicker(a,i,{placeholder:t("ed_placeholder","Collaborator username, name or numeric id, then Enter"),lookup:u,onCommit:e=>saveEditors(s.vaultId,e)});e.set(n.editors[s.vaultId]||[]),j.set(a,e)}}}contentChanged()}}async function loadAudiences(){if(I.me.admin){I.posts.loading=!0;var[t,a]=await Promise.all([api("/api/admin/vault"),api("/api/admin/collab")]);if(I.posts.loading=!1,t.ok&&t.data&&(I.posts.audiences=t.data.audiences||{}),a.ok&&a.data){I.posts.editors=a.data.editors||{},I.collab.people=a.data.people||[],I.me.grades=a.data.grades||I.me.grades;{let s=E.querySelector('[data-part="collab"]');if(s){let t=s.querySelector(".bm-collab-list"),a=new Map(I.collab.people.map(e=>[String(e.id),e])),i=(I.collab.roster||[]).map(e=>{var t=a.get(String(e.id));return{id:e.id,login:e.username||t&&t.login||"",name:e.name||"",panels:t&&t.panels||{}}});for(let[t,e]of a)i.some(e=>String(e.id)===t)||i.push({id:e.id,login:e.login,name:"",panels:e.panels||{}});s.querySelector(".bm-collab-count").textContent=i.length||"",t.innerHTML=i.length?`<ul class="bm-list">${i.map(collabRowHTML).join("")}</ul>`:`<p class="bm-blank">${e("c_empty","No collaborators are configured. Add them to backend.collaborators and to the Worker's COLLABORATORS, then rebuild.")}</p>`,contentChanged()}}}paintPosts()}}async function saveEditors(e,t){let a=E.querySelector(`[data-save="${CSS.escape("edit:"+e)}"]`);var i;t.settled?(a&&(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i>'),t=t.entries,i=await api(`/api/admin/vault/${encodeURIComponent(e)}/editors`,{method:"PUT",body:{editors:t}}),a&&(a.innerHTML=i.ok?'<i class="fa-solid fa-check" aria-hidden="true"></i>':'<i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>',i.ok)&&setTimeout(()=>a.innerHTML="",1800),i.ok&&(I.posts.editors[e]=t)):a&&(a.innerHTML="")}async function saveAudience(e,t){let a=E.querySelector(`[data-save="${CSS.escape("vault:"+e)}"]`);var i;t.settled?(a&&(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i>'),t=t.entries,i=await api(`/api/admin/vault/${encodeURIComponent(e)}/audience`,{method:"PUT",body:{audience:t}}),a&&(a.innerHTML=i.ok?'<i class="fa-solid fa-check" aria-hidden="true"></i>':'<i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>',i.ok)&&setTimeout(()=>a.innerHTML="",1800),i.ok&&(I.posts.audiences[e]=t,e=(i=E.querySelector(`[data-picker="${CSS.escape("vault:"+e)}"]`))&&i.closest(".bm-post").querySelector(".bm-bubble.is-readers"))&&(e.querySelector("strong").textContent=t.length,e.dataset.empty=t.length?"0":"1")):a&&(a.innerHTML="")}let P={gitea:"fa-solid fa-server",github:"fa-brands fa-github"},O=null,R=null,F=null;function loadRepo(){return O=O||import("./editor/repo.js")}async function holdCredentials(e){var t=await(R=R||import("./editor/credentials.js"));e?t.hold():t.release()}function rowEl(e){return E.querySelector(`.bm-post[data-key="${CSS.escape(e)}"]`)}function toggleUnpublish(a){var i,s=I.posts;s.busy||(a=a.dataset.key,(i=s.queue.indexOf(a))<0?s.queue.push(a):s.queue.splice(i,1),paintPosts(),(s.queue.length?()=>{let i=I.posts,a=!i.bar;if(a){let a=document.createElement("div");a.className="ed-docbar bm-unpub",a.innerHTML=`
      ...
      <div class="ed-notice" hidden></div>`,E.insertBefore(a,E.querySelector(".bm-console")),i.bar=a,holdCredentials(!0),a.querySelector(".bm-unpub-x").addEventListener("click",()=>closeBar()),a.querySelector(".bm-unpub-go").addEventListener("click",()=>(async()=>{let l=I.posts;if(!l.busy&&l.queue.length){let o=(()=>{let t=new Set(I.posts.queue);return I.posts.items.filter(e=>t.has(e.key))})();if(o.length){let e=l.bar,a=e.querySelector(".bm-unpub-go");l.busy=!0,E.classList.add("is-unpublishing"),n(a,!0),e.querySelector(".ed-dot").dataset.state="busy",barNotice(null,"");for(let e of o)rowEl(e.key)?.classList.add("is-working");var r=await loadRepo();F=_(e.querySelector(".ed-progress"),{repo:r,t:t,onDone:()=>{barNotice("info",t("p_unpub_land","Done. Loading the site as readers see it…")),setTimeout(()=>window.location.assign(v()+"/blog-management/"),1200)},onFail:e=>{"commit"!==e&&(barNotice("error",t("p_unpub_failed","The build failed. The commit landed; nothing published has changed.")),I.posts.busy=!1,E.classList.remove("is-unpublishing"))}});let s=!1;try{let e=await import("./editor/session.js"),a=(await r.open(!0),await e.unpublishAll(o));if(!a)throw new Error(t("p_unpub_empty","There was nothing to commit."));s=!0,F.committed(a),barNotice("info",(t("p_unpub_done","Committed")+" "+(a.short||"")).trim()),!1===a.started&&barNotice("warn",t("p_unpub_unstarted","Committed and queued, but the build was not started — try the operation again to retry."));let i=new Map((a.minted||[]).map(e=>[String(e.source||""),e]));for(let a of o){a.published=!1,"album"!==a.kind&&(a.encrypted=!1);let e=i.get(String(a.source||"")),t="album"===a.kind&&a.album&&a.album.title?await m(a.album.title):"";a.draft=a.draft||{id:e?e.id:t,slug:e?e.slug:a.slug||"",href:a.href,source:e?e.path:a.source},a.vaultId=a.draft&&a.draft.id||e&&e.id||t||""}l.queue=[],paintPosts()}catch(r){s||F.fail("commit"),barNotice("error",r&&r.message||t("offline","The Worker did not answer.")),l.busy=!1,E.classList.remove("is-unpublishing"),n(a,!1),e.querySelector(".ed-dot").dataset.state="dirty";for(let e of o)rowEl(e.key)?.classList.remove("is-working")}}else closeBar()}})()),a.querySelector(".bm-unpub-backend").addEventListener("click",()=>(async()=>{var s=I.posts.bar;if(s&&!I.posts.busy){let e=s.querySelector(".bm-unpub-backend"),a=await loadRepo(),i=a.backends().find(e=>e.id!==a.activeId());if(i){e.disabled=!0;try{await a.use(i.id),await paintBackend()}catch(s){barNotice("error",t("unreachable","Couldn't reach the backend."))}finally{e.disabled=!1}}}})())}var s=i.queue.length;i.bar.querySelector(".bm-unpub-count").textContent=s+" "+t(1===s?"p_unpub_one":"p_unpub_many",1===s?"post to withdraw":"posts to withdraw"),a&&(w(i.bar),paintBackend()),contentChanged()}:closeBar)())}function barNotice(e,t){var a,i=I.posts.bar;i&&(i=i.querySelector(".ed-notice"),t?(a="error"===e?"fa-circle-exclamation":"warn"===e?"fa-triangle-exclamation":"fa-circle-info",i.hidden=!1,i.dataset.kind=e,i.innerHTML=`<i class="fa-solid ${a}" aria-hidden="true"></i><span>${o(t)}</span>`,S(i)):i.hidden=!0)}async function closeBar(){var e=I.posts,t=(F&&F.stop(),e.queue=[],e.busy=!1,E.classList.remove("is-unpublishing"),e.bar);e.bar=null,paintPosts(),t&&(holdCredentials(!1),await k(t),t.remove(),contentChanged())}async function paintBackend(){var s=I.posts.bar;if(s){var n,l,r=s.querySelector(".bm-unpub-backend");let e;try{await(e=await loadRepo()).open(!1)}catch(s){return void(r.hidden=!0)}let a=e.backends(),i=e.activeId();!i||a.length<2?r.hidden=!0:(n=a.find(e=>e.id===i),l=a.find(e=>e.id!==i),r.hidden=!1,r.dataset.backend=i,r.innerHTML=`<i class="${P[i]||P.gitea}" aria-hidden="true"></i><span>${o(n&&n.label||i)}</span>`,r.title=l?t("p_backend","Build on")+" "+(l.label||l.id):"")}}function renderFollowersShell(i){i.innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-orphans"></div>`,x.forEach(a=>{var e=i.querySelector(`[data-picker="${a}"]`);j.set(a,makePicker(a,e,{placeholder:t("aud_placeholder","GitHub login or numeric id, then Enter"),onCommit:e=>(async(e,t)=>{let a=E.querySelector(`[data-save="${e}"]`);var i;t.settled?(a&&(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin" aria-hidden="true"></i>'),i=await api("/api/admin/blocklists",{method:"PUT",body:{topic:e,users:t.ids}}),a&&(a.innerHTML=i.ok?'<i class="fa-solid fa-check" aria-hidden="true"></i>':'<i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>',i.ok)&&setTimeout(()=>a.innerHTML="",1800),i.ok&&(i=i.data&&i.data.users||[],(I.blocklists[e]=i).length!==t.ids.length)&&t.set(i)):a&&(a.innerHTML="")})(a,e)}))})}function stateTag(t){return"banned"===t?`<span class="bm-tag is-banned">${e("banned","Banned")}</span>`:"muted"===t?`<span class="bm-tag is-muted">${e("muted","Muted")}</span>`:""}function lockOn(e){var t;return e&&e.is_admin?"admin":(t=I.followers,e=e&&(null!=e.id?e.id:e.github_id),"collab"===t.role&&null!=t.me&&String(e)===String(t.me)?"you":"")}function moderationButtons(t,a,i,s){return"admin"===s?`<span class="bm-tag is-admin">${e("admin","Admin")}</span>`:"you"===s?`<span class="bm-tag is-you">${e("you","You")}</span>`:(s="banned"===i,`
    ...
    </li>`}function paintFollowers(){var a=E.querySelector('[data-part="followers"]'),i=a.querySelector(".bm-followers"),s=a.querySelector(".bm-foot"),n=I.followers;n.totals&&(a.querySelector(".bm-follower-count").textContent=`${n.totals.followers} · ${n.totals.devices} `+t("m_devices","devices")),a.classList.toggle("is-loading",n.loading),n.loading&&!n.items.length?i.innerHTML=M:n.error?i.innerHTML=`<li class="bm-blank">${e("unreachable","Couldn't reach the notification service.")}</li>`:n.items.length?i.innerHTML=n.items.map(followerHTML).join(""):i.innerHTML=`<li class="bm-blank">${e("no_followers","Nobody follows the blog yet.")}</li>`,s.innerHTML=n.more?`<button type="button" class="bm-quiet bm-more" data-more="followers">
         <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
    ...
    </li>`}let D=[["info","INFO","a-2"],["warn","WARN","a-3"],["error","ERROR","a-1"],["fatal","FATAL","a-5"],["debug","DEBUG","a-6"],["other","","a-0"]],G=new Set(["debug","other"]),V=[.6,.7,.8,.9,1,1.15,1.3,1.5,1.75,2],J="redefine:build-log-view";function logView(){if(!I.log.view){let e={};try{e=JSON.parse(localStorage.getItem(J)||"{}")||{}}catch{}var t=Number(e.scale);I.log.view={off:new Set(Array.isArray(e.off)?e.off:[]),scale:Number.isInteger(t)&&V[t]?t:V.indexOf(1)}}return I.log.view}function saveLogView(){var e=logView();try{localStorage.setItem(J,JSON.stringify({off:[...e.off],scale:e.scale}))}catch{}}function paintLog(){var c=E.querySelector('[data-part="buildlog"]');if(c){var u=c.querySelector(".bm-log-body"),c=c.querySelector(".bm-log-when"),m=I.log.record;if(!I.log.loading){if(!m)return c.textContent="",u.innerHTML=`<p class="bm-blank">${e("l_empty","No build has written a log yet.")}</p>`,contentChanged();let n=logView(),{entries:a,counts:l}=p(m.text||""),i=m.status&&"success"!==m.status,s=String(m.build||m.sha||""),r=m.url?`<a class="bm-bubble" href="${o(m.url)}" target="_blank" rel="noopener" title="${e("l_run","Open the Actions run")}">`:'<span class="bm-bubble">',d=D.filter(([e])=>!G.has(e)||l[e]).map(([e,a,i])=>{var s=n.off.has(e);return`<button type="button" class="${s?"is-off":""}" data-level="${e}" aria-pressed="${s?"false":"true"}">
          <i class="${i}" aria-hidden="true"></i>${o(a||t("l_output","Output"))}<span class="bm-log-n">${l[e]||0}</span>
        </button>`}).join("");c.textContent=String(m.at||"").replace("T"," ").slice(0,16),u.innerHTML=`
    <div class="bm-log-head">
      ...
      ${m.reason?r+'<i class="fa-regular fa-play" aria-hidden="true"></i>'+o(m.reason)+(m.url?"</a>":"</span>"):""}
      ${s?`<span class="bm-bubble" title="${o(s)}"><i class="fa-regular fa-code-commit" aria-hidden="true"></i>${o(s.slice(0,7))}</span>`:""}
    </div>
    <div class="bma-legend bm-log-keys" role="group" aria-label="${e("l_levels","Log levels")}">${d}</div>
    <div class="bm-log-frame">
      <pre class="bm-log-text" data-log-scroller data-off="${[...n.off].join(" ")}" style="--log-scale:${V[n.scale]}"><code>${a.map(e=>`<span class="bm-log-e" data-level="${e.level}">${e.html}</span>`).join("")}</code></pre>
    ...
    </div>`;{c=u;let s=c.querySelector("[data-log-scroller]"),a=logView(),e=c.querySelectorAll("[data-zoom]"),i=()=>{var e=s.scrollWidth-s.clientWidth,t=s.scrollHeight-s.clientHeight,a=s.scrollLeft,i=s.scrollTop;s.classList.toggle("has-left",2<e&&2<a),s.classList.toggle("has-right",2<e&&2<e-a),s.classList.toggle("has-top",2<t&&2<i),s.classList.toggle("has-bottom",2<t&&2<t-i)},n=()=>{var t=s,n=t.querySelectorAll(".bm-log-logo-art");if(n.length){let e=getComputedStyle(t),a=t.clientWidth-parseFloat(e.paddingLeft)-parseFloat(e.paddingRight),i=parseFloat(e.fontSize),s=(e=>{if(Q&&Q.family===e)return Q.ratio;let t=1.2;try{var a=document.createElement("canvas").getContext("2d"),i=(a.font="100px "+e,a.measureText("█")),s=i.actualBoundingBoxAscent+i.actualBoundingBoxDescent;0<s&&(t=s/100)}catch{}return Q={family:e,ratio:t},t})(e.fontFamily);n.forEach(e=>{e.style.fontSize="20px";var t=e.getBoundingClientRect().width;!t||a<=0||(t=Math.min(i,Math.floor(20*a/t*.995*100)/100),e.style.fontSize=t+"px",e.style.lineHeight=Math.max(s*t-.33,s*t*.9)+"px")})}i(),e.forEach(e=>{var t=a.scale+Number(e.dataset.zoom);e.disabled=t<0||t>=V.length})};c.querySelector(".bm-log-keys").addEventListener("click",e=>{var t,e=e.target.closest("[data-level]");e&&(t=e.dataset.level,a.off.has(t)?a.off.delete(t):a.off.add(t),t=a.off.has(t),e.classList.toggle("is-off",t),e.setAttribute("aria-pressed",t?"false":"true"),s.dataset.off=[...a.off].join(" "),saveLogView(),n(),contentChanged())}),e.forEach(t=>t.addEventListener("click",()=>{var e=a.scale+Number(t.dataset.zoom);V[e]&&(a.scale=e,s.style.setProperty("--log-scale",String(V[e])),saveLogView(),n(),contentChanged())})),n(),s.addEventListener("scroll",i,{passive:!0}),"undefined"!=typeof ResizeObserver&&new ResizeObserver(n).observe(s),document.fonts&&document.fonts.ready&&document.fonts.ready.then(()=>s.isConnected&&n())}contentChanged()}}}let Q=null;async function boot(){var a,i,s,n;await!((s=await api("/api/editor/session")).ok&&s.data&&(I.me={admin:I.me.admin||!!s.data.admin,panels:s.data.panels||{},grades:s.data.grades||{},id:s.data.id||0,login:s.data.login||""},I.followers.me=I.me.id,I.followers.role=I.me.admin?"admin":"collaborator"));let l={posts:E.querySelector('[data-part="posts"]'),analytics:E.querySelector('[data-part="analytics"]'),announce:E.querySelector('[data-part="announce"]'),notifications:E.querySelector('[data-part="notifications"]'),followers:E.querySelector('[data-part="followers"]'),collab:E.querySelector('[data-part="collab"]'),buildlog:E.querySelector('[data-part="buildlog"]')},d=e=>I.me.admin?"rw":I.me.panels[e]||"",c={posts:!0,analytics:!!d("analytics"),announce:!!d("announce"),notifications:!!d("notifications"),followers:!!d("followers"),collab:I.me.admin,buildlog:!!d("buildlog")};for([a,i]of Object.entries(l))if(i&&!c[a]){i.remove(),l[a]=null;let e=(E.closest(".post-page-container")||document).querySelector(`a[href="#bm-${a}"]`);e&&e.closest(".nav-item")&&e.closest(".nav-item").remove()}l.posts&&(renderPostsShell(l.posts),paintPosts()),l.analytics&&r(l.analytics,E,t),l.announce&&((s=l.announce).innerHTML=`
    <h2 class="bm-section-title">
    ...
    <div class="bm-seg bm-notif-filter" role="group">
      ${s.map(([e,t])=>`<button type="button" data-type="${o(e)}"${e===I.notifications.type?' class="is-on"':""}>${o(t)}</button>`).join("")}
    </div>
    ...
    <div class="bm-log-body">${M}</div>`),l.posts&&loadAudiences(),l.notifications&&loadNotifications({reset:!0}),l.followers&&loadFollowers({reset:!0}),l.buildlog&&(async()=>{I.log.loading=!0,paintLog();try{var e=await api("/api/editor/keys",{method:"POST",body:{}}),t=(e.data&&e.data.items||[]).find(e=>"log"===e.kind);if(!t)throw new Error("no key");var a=await f(`${$()}/${t.slug}/log.bin`);I.log.record=a?JSON.parse(await y(await h(b(t.key)),a)):null}catch(e){I.log.record=null}I.log.loading=!1,paintLog()})()}function canCommit(){var e=window.theme&&window.theme.backend||{};return!(!e.online_editor||!e.online_editor.enable)}async function initBlogManagement(e,t){var a=document.getElementById("blog-management");a&&(E=a,j.clear(),I.me={admin:!(!t||!t.admin),panels:{},grades:{},id:0,login:""},I.compose.mode="all",I.notifications.type="",I.notifications.loading=!1,I.followers.loading=!1,I.posts.items=e&&e.items||[],I.posts.audiences={},I.posts.editors={},I.collab.roster=(window.theme&&window.theme.backend||{}).collaborators||[],I.log.record=null,I.posts.filter="",I.posts.queue=[],I.posts.bar=null,I.posts.busy=!1,F&&F.stop(),F=null,A=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.theme&&window.theme.backend||{},N=window.blogAuth?window.blogAuth.resolveApiBase():String(a.api_url||"").replace(/\/+$/,""),wire(),await boot(),!e)&&E.querySelector('[data-part="posts"]')&&(I.posts.items=(t=((t=await api("/api/editor/keys",{method:"POST",body:{}})).data&&t.data.items||[]).filter(e=>"post"===e.kind||"album"===e.kind),await(await Promise.all(t.map(async e=>{try{var t,a=await f(`${$()}/${e.slug}/r.bin`);return a?{...t=await g(await h(b(e.key)),a),vaultId:t.vaultId||e.id,slug:t.slug||e.slug,canWrite:!0===e.write}:null}catch(e){return null}}))).filter(Boolean)),paintPosts())}export{initBlogManagement};